...
!function(w){var o,k=function(b,c){"undefined"==typeof c&&(c={}),this.init(b,c)},a=k.prototype,p=["canvas","vml"],f=["oval","spiral","square","rect","roundRect"],x=/^\#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/,v=-1!==navigator.appVersion.indexOf("MSIE")&&8===parseFloat(navigator.appVersion.split("MSIE")[1])?!0:!1,y=!!document.createElement("canvas").getContext,q=!0,n=function(b,c,a){var d,b=document.createElement(b);for(d in a)b[d]=a[d];return"undefined"!=typeof c&&c.appendChild(b),b},m=function(b,c){for(var a in c)b.style[a]=c[a];return b},t=function(b,c){for(var a in c)b.setAttribute(a,c[a]);return b},u=function(b,c,a,d){b.save(),b.translate(c,a),b.rotate(d),b.translate(-c,-a),b.beginPath()};a.init=function(b,c){"boolean"==typeof c.safeVML&&(q=c.safeVML);try{this.mum=void 0!==document.getElementById(b)?document.getElementById(b):document.body}catch(a){this.mum=document.body}if(c.id="undefined"!=typeof c.id?c.id:"canvasLoader",this.cont=n("div",this.mum,{id:c.id}),y)o=p[0],this.can=n("canvas",this.cont),this.con=this.can.getContext("2d"),this.cCan=m(n("canvas",this.cont),{display:"none"}),this.cCon=this.cCan.getContext("2d");else{if(o=p[1],"undefined"==typeof k.vmlSheet){document.getElementsByTagName("head")[0].appendChild(n("style")),k.vmlSheet=document.styleSheets[document.styleSheets.length-1];var e,d=["group","oval","roundrect","fill"];for(e in d)k.vmlSheet.addRule(d[e],"behavior:url(#default#VML); position:absolute;")}this.vml=n("group",this.cont)}this.setColor(this.color),this.draw(),m(this.cont,{display:"none"})},a.cont={},a.can={},a.con={},a.cCan={},a.cCon={},a.timer={},a.activeId=0,a.diameter=40,a.setDiameter=function(b){this.diameter=Math.round(Math.abs(b)),this.redraw()},a.getDiameter=function(){return this.diameter},a.cRGB={},a.color="#000000",a.setColor=function(b){this.color=x.test(b)?b:"#000000",this.cRGB=this.getRGB(this.color),this.redraw()},a.getColor=function(){return this.color},a.shape=f[0],a.setShape=function(b){for(var c in f)if(b===f[c]){this.shape=b,this.redraw();break}},a.getShape=function(){return this.shape},a.density=40,a.setDensity=function(b){this.density=q&&o===p[1]?Math.round(Math.abs(b))<=40?Math.round(Math.abs(b)):40:Math.round(Math.abs(b)),this.density>360&&(this.density=360),this.activeId=0,this.redraw()},a.getDensity=function(){return this.density},a.range=1.3,a.setRange=function(b){this.range=Math.abs(b),this.redraw()},a.getRange=function(){return this.range},a.speed=2,a.setSpeed=function(b){this.speed=Math.round(Math.abs(b))},a.getSpeed=function(){return this.speed},a.fps=24,a.setFPS=function(b){this.fps=Math.round(Math.abs(b)),this.reset()},a.getFPS=function(){return this.fps},a.getRGB=function(b){return b="#"===b.charAt(0)?b.substring(1,7):b,{r:parseInt(b.substring(0,2),16),g:parseInt(b.substring(2,4),16),b:parseInt(b.substring(4,6),16)}},a.draw=function(){var c,a,d,e,h,k,j,l,i,b=0,r=this.density,s=Math.round(r*this.range),q=0;i=this.cCon;var g=this.diameter;if(o===p[0])for(i.clearRect(0,0,1e3,1e3),t(this.can,{width:g,height:g}),t(this.cCan,{width:g,height:g});r>b;){switch(l=s>=b?1-1/s*b:l=0,k=270-360/r*b,j=k/180*Math.PI,i.fillStyle="rgba("+this.cRGB.r+","+this.cRGB.g+","+this.cRGB.b+","+l.toString()+")",this.shape){case f[0]:case f[1]:c=.07*g,e=.47*g+Math.cos(j)*(.47*g-c)-.47*g,h=.47*g+Math.sin(j)*(.47*g-c)-.47*g,i.beginPath(),this.shape===f[1]?i.arc(.5*g+e,.5*g+h,c*l,0,2*Math.PI,!1):i.arc(.5*g+e,.5*g+h,c,0,2*Math.PI,!1);break;case f[2]:c=.12*g,e=Math.cos(j)*(.47*g-c)+.5*g,h=Math.sin(j)*(.47*g-c)+.5*g,u(i,e,h,j),i.fillRect(e,h-.5*c,c,c);break;case f[3]:case f[4]:a=.3*g,d=.27*a,e=Math.cos(j)*(d+.13*(g-d))+.5*g,h=Math.sin(j)*(d+.13*(g-d))+.5*g,u(i,e,h,j),this.shape===f[3]?i.fillRect(e,h-.5*d,a,d):(c=.55*d,i.moveTo(e+c,h-.5*d),i.lineTo(e+a-c,h-.5*d),i.quadraticCurveTo(e+a,h-.5*d,e+a,h-.5*d+c),i.lineTo(e+a,h-.5*d+d-c),i.quadraticCurveTo(e+a,h-.5*d+d,e+a-c,h-.5*d+d),i.lineTo(e+c,h-.5*d+d),i.quadraticCurveTo(e,h-.5*d+d,e,h-.5*d+d-c),i.lineTo(e,h-.5*d+c),i.quadraticCurveTo(e,h-.5*d,e+c,h-.5*d))}i.closePath(),i.fill(),i.restore(),++b}else{switch(m(this.cont,{width:g,height:g}),m(this.vml,{width:g,height:g}),this.shape){case f[0]:case f[1]:j="oval",c=140;break;case f[2]:j="roundrect",c=120;break;case f[3]:case f[4]:j="roundrect",c=300}for(a=d=c,e=500-d,h=.5*-d;r>b;){switch(l=s>=b?1-1/s*b:l=0,k=270-360/r*b,this.shape){case f[1]:a=d=c*l,e=500-.5*c-c*l*.5,h=.5*(c-c*l);break;case f[0]:case f[2]:v&&(h=0,this.shape===f[2]&&(e=500-.5*d));break;case f[3]:case f[4]:a=.95*c,d=.28*a,v?(e=0,h=500-.5*d):(e=500-a,h=.5*-d),q=this.shape===f[4]?.6:0}i=t(m(n("group",this.vml),{width:1e3,height:1e3,rotation:k}),{coordsize:"1000,1000",coordorigin:"-500,-500"}),i=m(n(j,i,{stroked:!1,arcSize:q}),{width:a,height:d,top:h,left:e}),n("fill",i,{color:this.color,opacity:l}),++b}}this.tick(!0)},a.clean=function(){if(o===p[0])this.con.clearRect(0,0,1e3,1e3);else{var b=this.vml;if(b.hasChildNodes())for(;b.childNodes.length>=1;)b.removeChild(b.firstChild)}},a.redraw=function(){this.clean(),this.draw()},a.reset=function(){"number"==typeof this.timer&&(this.hide(),this.show())},a.tick=function(b){var a=this.con,f=this.diameter;b||(this.activeId+=360/this.density*this.speed),o===p[0]?(a.clearRect(0,0,f,f),u(a,.5*f,.5*f,this.activeId/180*Math.PI),a.drawImage(this.cCan,0,0,f,f),a.restore()):(this.activeId>=360&&(this.activeId-=360),m(this.vml,{rotation:this.activeId}))},a.show=function(){if("number"!=typeof this.timer){var a=this;this.timer=self.setInterval(function(){a.tick()},Math.round(1e3/this.fps)),m(this.cont,{display:"block"})}},a.hide=function(){"number"==typeof this.timer&&(clearInterval(this.timer),delete this.timer,m(this.cont,{display:"none"}))},a.kill=function(){var a=this.cont;"number"==typeof this.timer&&this.hide(),o===p[0]?(a.removeChild(this.can),a.removeChild(this.cCan)):a.removeChild(this.vml);for(var c in this)delete this[c]},w.CanvasLoader=k}(window);
var mk;mk=function(){function mk(){}return mk.prototype.array=function(data,out,div1,div2){var error,i,params,put,_i,_ref;try{for(div1=div1?div1:"|",div2=div2?div2:"->",data=data.split(div1),out||(params=""),i=_i=0,_ref=data.length-1;_ref>=0?_ref>=_i:_i>=_ref;i=_ref>=0?++_i:--_i)put=data[i].split(div2),out?out[put[0].trim()]=put[1].trim():""!==put[1].trim()&&"null"!==put[1].trim()&&"undefined"!==put[1].trim()&&"false"!==put[1].trim()&&(params+="&"+put[0].trim()+"="+put[1].trim());if(""!==params)return params}catch(_error){return error=_error,console.log("- Error en mk::array, "+error)}},mk.prototype.key=function(keySize,special){var iteration,number,password;for(iteration=0,password="",number=!0,special&&(special=!1);keySize>iteration;)if(number=Math.floor(100*Math.random())%94+33,!special){if(number>=33&&47>=number)continue;if(number>=58&&64>=number)continue;if(number>=91&&96>=number)continue;if(number>=123&&126>=number)continue;iteration++,password+=String.fromCharCode(number)}return password},mk.prototype.name=function(name){return name=name?name:"default name",name=name.replace(/\s/g,"_"),name=""+name+"_"+this.key(5)},mk.prototype.lock=function(target){return $("body").on("contextmenu",target,function(event){return event.preventDefault()})},mk}(),$('[href="#"][type="button"]').click(function(event){return event.preventDefault()});var LockMask;LockMask=function(){function LockMask(){}return LockMask.prototype.loader={anim:function(){var obj;return obj=new CanvasLoader("lock-mask"),obj.setColor("#D8D8D8"),obj.setShape("square"),obj.setDiameter(35),obj.setDensity(12),obj.setRange(1.2),obj.setFPS(9),obj.show()},box:'<div id="lock-mask" class="lock-mask">'},LockMask.prototype.block=function(){var blockHeight,blockWidth,posLeft,posTop,scope;return scope=this,blockHeight=$(scope.option.container).outerHeight(),blockWidth=$(scope.option.container).outerWidth(),posLeft=$(scope.option.container).position().left,posTop=$(scope.option.container).position().top,"body"===scope.option.block&&(blockHeight=$(document).height(),blockWidth=$(document).width(),posLeft="0px",posTop="0px"),scope.loader.anim(),$(scope.option.block+" #lock-mask").css({position:"absolute",height:blockHeight,width:blockWidth,left:posLeft,top:posTop}).fadeIn("slow").on("contextmenu",function(event){return event.preventDefault()})},LockMask}();var AjaxModal;AjaxModal=function(){function AjaxModal(){}return AjaxModal.prototype.modal=function(option){return"<div class='modal fade' id='AjaxModal'>\n	<div class='modal-dialog "+option.size+"'>\n		<div class='modal-content'>\n			<div class='modal-header bg-"+option.color+"'>\n				<button type='button' class='close' data-dismiss='modal'>\n					<i class='fa fa-times'></i>\n				</button>\n				<h4 class='modal-title text-"+option.color+"'><i class=\"fa fa-"+option.icon+'"></i> '+option.title+"</h4>\n			</div>\n			<div class='modal-body'>"+option.content+"</div>							\n			<div class='modal-footer'>"+option.footer+"</div>\n		</div>\n	</div>\n</div>"},AjaxModal.prototype.options=function(option){return"ajax"===option.type?"<a href='#' class='btn btn-"+option.color+"' data-dismiss='modal'><i class='fa fa-sign-out fa-fw'></i> Cerrar</a>":"<div class='btn-group'>\n	<a href='"+option.url+"' class='btn btn-"+option.color+" btn-sm'> <i class=\"fa fa-"+option.icon+" fa-fw\"></i> Continuar</a>\n	<a href='#' class='btn btn-default btn-sm' data-dismiss='modal'> <i class=\"fa fa-sign-out fa-fw\"></i> Cancelar</a>\n</div>"},AjaxModal.prototype.start=function(){var option,scope;return option=new Array,scope=this,$("body").on("click","[data-modal]",function(event){var error;event.preventDefault();try{return $("#AjaxModal").remove(),mk.prototype.array($(this).attr("data-modal"),option),"ajax"===option.type?$.ajax({type:"POST",cache:!1,url:option.url,success:function(data){return option.content=data,option.size=option.size?"modal-"+option.size:"",option.footer="off"!==option.controls?scope.options(option):"",option.color=option.color?option.color:option.type,$(scope.modal(option)).appendTo("body"),option.title=option.title?option.title:"",$("#AjaxModal").modal("show")}}):(option.size=option.size?"modal-"+option.size:"modal-sm",option.footer="off"!==option.controls?scope.options(option):"",option.color=option.color?option.color:option.type,$(scope.modal(option)).appendTo("body")),$("#AjaxModal").modal("show")}catch(_error){return error=_error,console.log("- Error en AjaxModal, "+error)}})},AjaxModal}(),AjaxModal=new AjaxModal,AjaxModal.start(),$("body").on("click",".lock",function(event){return event.preventDefault()});var SiteCanvasContainer,siteCanvasContainer;SiteCanvasContainer=function(){function SiteCanvasContainer(){this.num=120,this.margenAncho=2*$(window).width()/100,this.margenAlto=30*$(window).height()/100,this.SiteCanvasContainer=$(".SiteCanvasContainer")}return SiteCanvasContainer.prototype.starHtml=function(id){return"<div class='star' id='star-"+id+"'></div>"},SiteCanvasContainer.prototype.randomValuesFor=function(target){var randomLeft,randomSize,randomTop,scope;return scope=this,randomLeft=Math.floor(Math.random()*($(window).width()-scope.margenAncho)+1),randomTop=Math.floor(Math.random()*($(window).height()-scope.margenAlto)+1),randomSize=Math.floor(7*Math.random()+1),$(target).css({left:randomLeft,top:randomTop,width:randomSize,height:randomSize})},SiteCanvasContainer.prototype.createStars=function(){var scope,starNum,_i,_ref,_results;for(scope=this,_results=[],starNum=_i=0,_ref=scope.num-1;_ref>=0?_ref>=_i:_i>=_ref;starNum=_ref>=0?++_i:--_i)scope.SiteCanvasContainer.prepend(scope.starHtml(starNum)),_results.push(scope.starsPosition(starNum));return _results},SiteCanvasContainer.prototype.starsPosition=function(starNum){var scope,star;return scope=this,star="#star-"+starNum,scope.randomValuesFor(star)},SiteCanvasContainer.prototype.animateStars=function(){var scope,star,starAnimate,starNum,_i,_ref,_results;for(scope=this,_results=[],starNum=_i=0,_ref=79;_ref>=0?_ref>=_i:_i>=_ref;starNum=_ref>=0?++_i:--_i)starAnimate=Math.floor(Math.random()*scope.num+1),star=$(".star:eq("+starAnimate+")"),star.hasClass("starShining")?_results.push(void 0):_results.push(star.addClass("starShining"));return _results},SiteCanvasContainer.prototype.animateAstro=function(){var scope;return scope=this,setInterval(function(){var cometa;return cometa="#star-cometa",scope.SiteCanvasContainer.append(scope.starHtml("cometa")),scope.randomValuesFor(cometa),$(cometa).animate({left:"-=100",top:"+=200",opacity:"0"},1e3,function(){return $(this).remove()})},5e3)},SiteCanvasContainer}(),siteCanvasContainer=new SiteCanvasContainer,siteCanvasContainer.createStars(),siteCanvasContainer.animateStars(),siteCanvasContainer.animateAstro();var EmailFormController,mailSender;EmailFormController=function(){function EmailFormController(){}return EmailFormController.prototype.sendEmail=function(){return $("body").on("submit",'[role="ContactForm"]',function(event){return event.preventDefault(),$.ajax({url:$(this).attr("action"),type:"POST",data:$(this).serialize(),success:function(response){return $(".emailErrorsContainer").html(response)}})})},EmailFormController}(),mailSender=new EmailFormController,mailSender.sendEmail();var HOST;HOST=window.location.host;var routeConfig;routeConfig=function($routeProvider){return $routeProvider.when("/home",{controller:"ContentController",controllerAs:"vm",templateUrl:"/home"}).when("/work",{controller:"ContentController",controllerAs:"vm",templateUrl:"/work"}).when("/about",{controller:"ContentController",controllerAs:"vm",templateUrl:"/about"}).when("/work-article/:articleId",{controller:"WorkArticleController",controllerAs:"vm",templateUrl:function(params){return"/work-article/"+params.articleId}}).when("/profile/:profileId",{controller:"AboutProfileController",controllerAs:"vm",templateUrl:function(params){return"/profile/"+params.profileId}}).otherwise({redirectTo:"/home"})};var NavBarController;NavBarController=function(){function NavBarController($location,$window,$rootScope){var vm;vm=this,$rootScope.place=function(ruta){return 0===$location.path().indexOf(ruta)||$location.path()===ruta},$rootScope.backButton=function(){return 0===$location.path().indexOf("/work")?"./#/work":0===$location.path().indexOf("/about")?"./#/about":void 0}}return NavBarController}();var ContentController;ContentController=function(){var vm;return vm=this,vm.prueba="esta es una prueba"};var WorkArticleController;WorkArticleController=function(){function WorkArticleController(){var vm;vm=this,vm.workArticle=!0,vm.aboutArticle=!1,vm.sectionType="workArticle"}return WorkArticleController}();var AboutProfileController;AboutProfileController=function(){function AboutProfileController(){var vm;vm=this,vm.workArticle=!1,vm.aboutArticle=!0,vm.sectionType="userProfile"}return AboutProfileController}(),angular.module("SiteInfoApp",["ngRoute"]).config(["$routeProvider",routeConfig]).controller(["$http",ContentController]).controller(["$http",WorkArticleController]).controller(["$location","$rootScope",NavBarController]);